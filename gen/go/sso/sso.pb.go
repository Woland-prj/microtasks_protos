...
type RegisterRespones struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Uid           uint64                 `protobuf:"varint,1,opt,name=uid,proto3" json:"uid,omitempty"` // ID of registered user
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RegisterRespones) GetUid() uint64 {
	if x != nil {
		return x.Uid
	}
	return 0
...
type LoginRequest struct {
	...
	AppId         int32                  `protobuf:"varint,3,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"` // ID of loggining service
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *LoginRespones) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x65, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f,
	0x6b, 0x65, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e,
	0x32, 0x73, 0x0a, 0x04, 0x61, 0x75, 0x74, 0x68, 0x12, 0x39, 0x0a, 0x08, 0x52, 0x65, 0x67, 0x69,
	...
	0x6e, 0x65, 0x73, 0x12, 0x30, 0x0a, 0x05, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x12, 0x12, 0x2e, 0x61,
	...
	0x70, 0x6f, 0x6e, 0x65, 0x73, 0x42, 0x19, 0x5a, 0x17, 0x6d, 0x69, 0x63, 0x72, 0x6f, 0x74, 0x61,
	0x73, 0x6b, 0x73, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b, 0x73, 0x73, 0x6f, 0x76, 0x31,
